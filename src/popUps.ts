...
export enum PopUpOpts {
  ...
  Whiteboard = 'toolbar=0,scrollbars=1,status=1,resizable=1,location=1,menuBar=0,width=800,height=600,left=600,top=200',
  ManageWhiteboards = 'toolbar=0,scrollbars=1,status=1,resizable=1,location=1,menuBar=0,width=800,height=600,left=600,top=200'
}
